...
- MongoDB & Mongoose : For storing teacher, student, timetable and substitution data
- EJS (Embedded JavaScript Templates):For server-side HTML rendering.
- Nodemailer : For sending email notifications - HTML, CSS, JS – For frontend interface.
